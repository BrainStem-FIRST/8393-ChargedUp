...
public class AutoDepositSequenceCommandGroup extends SequentialCommandGroup {
    Lift m_lift;
    ...
    public AutoDepositSequenceCommandGroup(Lift p_lift, Extension p_extension, Collector p_collector) {
        this.m_lift = p_lift;
