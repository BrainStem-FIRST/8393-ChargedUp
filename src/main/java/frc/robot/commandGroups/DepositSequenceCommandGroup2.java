...
public class DepositSequenceCommandGroup2 extends SequentialCommandGroup {
    Lift m_lift;
    ...
    public DepositSequenceCommandGroup2(Lift p_lift, Extension p_extension, Collector p_collector) {
        this.m_lift = p_lift;
