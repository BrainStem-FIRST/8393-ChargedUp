...
public class AutoHighPoleApproachCommandGroup extends SequentialCommandGroup {
    
    public AutoHighPoleApproachCommandGroup(Extension extension, Lift lift, Collector collector) {
        addCommands(
            new InstantCommand(() -> lift.m_state = LiftPosition.AUTO_DEPOSIT)
            , new WaitCommand(0.45)
            ,new AutoHighPoleExtensionCommandGroup(extension),
