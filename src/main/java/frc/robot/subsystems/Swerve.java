...
public class Swerve extends SubsystemBase implements BrainSTEMSubsystem{
    public static final class SwerveConstants {
        ...
        public static final double k_trackWidth = Units.inchesToMeters(21.73); //TODO: This must be tuned to specific robot
        public static final double k_wheelBase = Units.inchesToMeters(21.73); //TODO: This must be tuned to specific robot
        ...
        public static final class Mod0Constants { //TODO: This must be tuned to specific robot
            ...
            public static final SwerveModuleConstants k_constants = 
                new SwerveModuleConstants(k_driveMotorID, k_angleMotorID, k_canCoderID, k_angleOffset);
        }
